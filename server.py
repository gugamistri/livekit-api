...
class TokenRequest(BaseModel):
    ...
    voiceModel       Optional[str]          = Filed(None, description="Voice Model to use" 
    ...
    try:
        ...
        await _dispatch_agent(
            AgentConfig(
                ...
                tts_voice= "5063f45b-d9e0-4095-b056-8f3ee055d411" if  body.voiceModel=="male" else  "2ccd63be-1c60-4b19-99f6-fa7465af0738",
